...
@interface CDAddressManager ()

@end

@implementation CDAddressManager
...
+ (CDAddressManager *)manager; // Manager using default RLCoreDataEnvironment singleton
{
    return [[CDAddressManager alloc] initWithCoreDataEnvironment:[RLCoreDataEnvironment singleton]];
}
