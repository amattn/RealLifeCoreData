...
@interface RLCoreDataEnvironment ()
@property (atomic, strong, readonly) NSMutableDictionary *managedObjectContextHash;
...
@implementation RLCoreDataEnvironment
    ...
    {        
        ...
        self.errorHandlerBlock = ^(NSError *error, SEL selectorWithError, BOOL isFatal)
        {
            ...
            if (isFatal)
            {
                ...
                NSString *desc = [NSString stringWithFormat:@"FATAL RLCoreDataEnvironment ERROR: %@", error];
