/******************************************************************************
 * - Created 2012/05/02 by Matt Nunogawa
...
@interface RLFetchedResultsViewController : UIViewController <NSFetchedResultsControllerDelegate>
{
    // The ivars declared under the @protected directive are strictly for the use of the subclasses
    @protected
