 ...
 *  \version 2.1.2
 *  \copyright Copyright Matt Nunogawa 2003-2012. All rights reserved.
 */
...
#define LOG_COORD2D(coord)  (NSLog(@"" #coord @" lat,lon: %+.9f,%+.9f",coord.latitude, coord.longitude ));
...
// BEGIN Stolen from ScreenSaverView.h
...
// END Stolen from ScreenSaverView.h
